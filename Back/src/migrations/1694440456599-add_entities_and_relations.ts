...
export class AddEntitiesAndRelations1694440456599 implements MigrationInterface {
    name = 'AddEntitiesAndRelations1694440456599'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "furnitures" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "value" integer NOT NULL, "amount" integer NOT NULL, "is_available" boolean NOT NULL DEFAULT true, "cartId" integer, CONSTRAINT "UQ_0fedf15e6819ac05a45cab39e99" UNIQUE ("name"), CONSTRAINT "PK_7effa6aa3ab998c431ea028393a" PRIMARY KEY ("id"))`);
