    ...
    <nav className="fixed flex items-center h-[100px] top-0 left-0 right-0 z-50 ease-in duration-300 bg-gray-0 shadow-2xl shadow-gray-100/70">
        <div className="w-[90vw] m-auto flex justify-between items-center">
            ...
            <ul className="hidden lg:flex">
                ...
                <Link className="nav group text-gray-1000" href={"/products"}>Produtos <span className="absolute left-0 bottom-0 h-[2px] w-0 bg-brand1-1000 transition-all duration-500 ease-in-out group-hover:w-full"></span></Link>
                <Link className="nav group text-gray-1000" href={"#contact_footer"}>Contatos <span className="absolute left-0 bottom-0 h-[2px] w-0 bg-brand1-1000 transition-all duration-500 ease-in-out group-hover:w-full"></span></Link>
            </ul>
                ...
                <div className="flex items-start flex-col w-[90%] h-[100%] gap-5">
                        ...
                        <ul className="lg:hidden w-[100%] flex flex-col items-start mt-[32px]">
                            <li className="w-[100%] h-[100px] flex items-center border-t-2 border-brand2-1000">
                                <Link href={"/"} className="w-[100%] flex">Início</Link>
                            </li>
                            <li className="w-[100%] h-[100px] flex items-center border-t-2 border-brand2-1000">
                                <Link href={""} className="w-[100%] flex">Quem Somos</Link>
                            </li>
                            <li className="w-[100%] h-[100px] flex items-center border-t-2 border-brand2-1000">
                                <Link href="/products" className="w-[100%] flex">Produtos</Link>
                            </li>
                            <li className="w-[100%] h-[100px] flex items-center border-t-2 border-brand2-1000">
                                <Link href={"#contact_footer"} onClick={() => setNav(false)} className="w-[100%] flex">Contatos</Link>
                            </li>
                        </ul>
                </div>
            </div>
            ...
            currentUrl === "/dashbord"? null :
                <div className="hidden lg:flex items-center gap-11">
                    ...
                    <Link href="/register" className="border-2 border-gray-400 rounded-lg p-[7px_12px] bg-gray-300 hover:bg-brand1-1000 hover:text-gray-0 hover:border-brand1-750 duration-300" >Cadastra-se</Link>
                </div>
            }
        </div>
    </nav>
