...
import { CarouselMainProducts } from "../Carousel/Products";
...
export const Main = ({furniture}: FurnitureProps) => {
  ...
  return (
    <main
      className="overflow-x-hidden flex flex-col justify-center items-center z-0 mt-[100px]"
    >
      <div className="flex flex-col items-center ustify-center w-full min-h-screen bg-fixed bg-center bg-cover relative bg-image1">
      ...
      <section className="relative min-h-[800px] w-full bg-fixed bg-center bg-cover bg-no-repeat bg-image2 ">
      ...
      <section className="flex justify-center items-center p-[80px_0px] w-full bg-brand1-750 relative">
        <div className="container flex-col item-center justify-center gap-20">
          <h2 className="self-center text-2xl text-gray-250">Destaques</h2>
