...
export const LoginForm = () => {
  ...
  return (
    <div className="w-[75%] sm:w-[50%] sm:h-[75%] pb-4 sm:pb-0 bg-gray-250 rounded-xl shadow-2xl shadow-gray-250/40 flex flex-col sm:flex-row justify-evenly items-center">
      ...
      <div className="flex flex-col justify-center gap-[62px] items-center h-[90%] w-[90%] sm:w-[50%]">
        ...
        <div className="flex flex-col items-center gap-5">
           <span>Não tem uma conta? <Link className="text-brand1-1000 border-b-2 hover:border-b-2 hover:border-brand1-1000 duration-150" href={"/register"}>Crie uma!</Link></span>
