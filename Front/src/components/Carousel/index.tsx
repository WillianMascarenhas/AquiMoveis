...
export const CarouselMain = () => {
  ...
  return (
    <div className="max-w-[1400px] h-[600px] w-full m-auto py-16 px-4 relative">
      ...
      <div
        onClick={prevSlide}
        className="absolute top-1/2 translate-x-0 translate-y-[-50%] left-7 text-2xl rounded-full p-2 bg-black/20 text-gray-250 hover:text-brand1-1000 hover:bg-brand2-1000/20 duration-200 cursor-pointer"
      >
        <BsChevronCompactLeft size={20} />
      </div>
      {/* Arrow right */}
      <div
        onClick={nextSlide}
        className="absolute top-1/2 translate-x-0 translate-y-[-50%] right-7 text-2xl rounded-full p-2 bg-black/20 text-gray-250 hover:text-brand1-1000 hover:bg-brand2-1000/20 duration-200 ho cursor-pointer"
      >
        <BsChevronCompactRight size={20} t />
      </div>
